...
<ins> - Inserted text => <ins>- нижное подчеркивание текста
...
<html lang="en">
  ...
  <body>
    <details>
      ...
      <h1 title="about title">heading 1</h1>
      <h1 class="testclass">heading 2</h1>
      <h1 id="testid1">heading 3</h1>
      <h1 style="color: red; background-color: gray">heading 4</h1>
    </details>
...
<td rowspan="2"></td>  Чтобы ячейка охватывала несколько строк, используйте rowspan атрибут:
